...
import 'package:dev_gallery/features/developers/presentation/widgets/developer_tile.dart';
import 'package:flutter/material.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import '../../../../injection_container.dart';
import '../bloc/developers_bloc/developers_bloc.dart';
import '../bloc/developers_bloc/developers_event.dart';
import '../bloc/developers_bloc/developers_state.dart';
...
class _DevsLoading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemCount: 8,
      itemBuilder: (_, __) => DeveloperTile(
